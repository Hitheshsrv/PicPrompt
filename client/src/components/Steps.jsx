...
const Steps = () => {
  return (
    ...
    >
      ...
      <p className='text-gray-600 text-lg mb-8'>Transform Texts Into Stunning Images</p>
      <div className='space-y-4 w-full max-w-3xl text-sm'>
        {stepsData.map((item,index) => (
          <div
          className='flex items-center gap-4 p-5 px-8 bg-white/20 shadow-xl border cursor-pointer hover:scale-[1.02] transition-all duration-300 rounded-lg'
          key={index} >
